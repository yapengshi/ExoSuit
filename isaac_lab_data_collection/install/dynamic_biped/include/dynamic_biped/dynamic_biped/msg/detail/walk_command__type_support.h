...
#ifndef DYNAMIC_BIPED__MSG__DETAIL__WALK_COMMAND__TYPE_SUPPORT_H_
#define DYNAMIC_BIPED__MSG__DETAIL__WALK_COMMAND__TYPE_SUPPORT_H_
...
#endif  // DYNAMIC_BIPED__MSG__DETAIL__WALK_COMMAND__TYPE_SUPPORT_H_
