...
#ifndef DYNAMIC_BIPED__SRV__DETAIL__CONTROL_END_HAND__FUNCTIONS_H_
#define DYNAMIC_BIPED__SRV__DETAIL__CONTROL_END_HAND__FUNCTIONS_H_
...
/// Initialize srv/ControlEndHand message.
/**
 ...
 * )) before or use
 * dynamic_biped__srv__ControlEndHand_Request__create()
...
/// Finalize srv/ControlEndHand message.
/**
...
/// Create srv/ControlEndHand message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dynamic_biped__srv__ControlEndHand_Request__init().
...
/// Destroy srv/ControlEndHand message.
/**
 * It calls
 * dynamic_biped__srv__ControlEndHand_Request__fini()
...
/// Check for srv/ControlEndHand message equality.
/**
...
/// Copy a srv/ControlEndHand message.
/**
...
/// Initialize array of srv/ControlEndHand messages.
/**
...
/// Finalize array of srv/ControlEndHand messages.
/**
 * It calls
 * dynamic_biped__srv__ControlEndHand_Request__fini()
...
/// Create array of srv/ControlEndHand messages.
/**
 * It allocates the memory for the array and calls
 * dynamic_biped__srv__ControlEndHand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ControlEndHand messages.
/**
 * It calls
 * dynamic_biped__srv__ControlEndHand_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ControlEndHand message array equality.
/**
...
/// Copy an array of srv/ControlEndHand messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * dynamic_biped__srv__ControlEndHand_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamic_biped
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dynamic_biped__srv__ControlEndHand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamic_biped
...
/**
 * It calls
 * dynamic_biped__srv__ControlEndHand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamic_biped
...
/**
 * It allocates the memory for the array and calls
 * dynamic_biped__srv__ControlEndHand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamic_biped
...
/**
 * It calls
 * dynamic_biped__srv__ControlEndHand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * dynamic_biped__srv__ControlEndHand_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamic_biped
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dynamic_biped__srv__ControlEndHand_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamic_biped
...
/**
 * It calls
 * dynamic_biped__srv__ControlEndHand_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamic_biped
...
/**
 * It allocates the memory for the array and calls
 * dynamic_biped__srv__ControlEndHand_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dynamic_biped
...
/**
 * It calls
 * dynamic_biped__srv__ControlEndHand_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DYNAMIC_BIPED__SRV__DETAIL__CONTROL_END_HAND__FUNCTIONS_H_
