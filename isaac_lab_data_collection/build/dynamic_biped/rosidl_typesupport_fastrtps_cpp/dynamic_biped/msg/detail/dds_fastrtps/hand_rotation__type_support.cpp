...
#include "dynamic_biped/msg/detail/hand_rotation__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dynamic_biped::msg::HandRotation & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamic_biped::msg::HandRotation & ros_message)
{
  // Member: quaternions
  {
    uint32_t cdrSize;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dynamic_biped
max_serialized_size_HandRotation(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamic_biped::msg::HandRotation;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dynamic_biped
max_serialized_size_key_HandRotation(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const dynamic_biped::msg::HandRotation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamic_biped::msg::HandRotation *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HandRotation__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dynamic_biped::msg::HandRotation *>(
...
static size_t _HandRotation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HandRotation(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HandRotation__callbacks = {
  "dynamic_biped::msg",
  "HandRotation",
...
static rosidl_message_type_support_t _HandRotation__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HandRotation__callbacks,
...
{
  return &dynamic_biped::msg::typesupport_fastrtps_cpp::_HandRotation__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamic_biped, msg, HandRotation)() {
  return &dynamic_biped::msg::typesupport_fastrtps_cpp::_HandRotation__handle;
}
