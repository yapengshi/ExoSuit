...
#include "dynamic_biped/msg/detail/walk_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dynamic_biped::msg::WalkCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dynamic_biped::msg::WalkCommand & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dynamic_biped
max_serialized_size_WalkCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamic_biped::msg::WalkCommand;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dynamic_biped
max_serialized_size_key_WalkCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const dynamic_biped::msg::WalkCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dynamic_biped::msg::WalkCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WalkCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dynamic_biped::msg::WalkCommand *>(
...
static size_t _WalkCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_WalkCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _WalkCommand__callbacks = {
  "dynamic_biped::msg",
  "WalkCommand",
...
static rosidl_message_type_support_t _WalkCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WalkCommand__callbacks,
...
{
  return &dynamic_biped::msg::typesupport_fastrtps_cpp::_WalkCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamic_biped, msg, WalkCommand)() {
  return &dynamic_biped::msg::typesupport_fastrtps_cpp::_WalkCommand__handle;
}
