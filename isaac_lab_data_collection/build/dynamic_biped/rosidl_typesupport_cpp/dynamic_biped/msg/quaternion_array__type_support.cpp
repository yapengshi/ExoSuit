...
static const _QuaternionArray_type_support_symbol_names_t _QuaternionArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dynamic_biped, msg, QuaternionArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dynamic_biped, msg, QuaternionArray)),
  }
};
...
{
  return &::dynamic_biped::msg::rosidl_typesupport_cpp::QuaternionArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dynamic_biped, msg, QuaternionArray)() {
  return get_message_type_support_handle<dynamic_biped::msg::QuaternionArray>();
}
