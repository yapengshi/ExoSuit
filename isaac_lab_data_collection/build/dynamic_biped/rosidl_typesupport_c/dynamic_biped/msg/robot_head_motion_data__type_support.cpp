...
static const _RobotHeadMotionData_type_support_symbol_names_t _RobotHeadMotionData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamic_biped, msg, RobotHeadMotionData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dynamic_biped, msg, RobotHeadMotionData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dynamic_biped, msg, RobotHeadMotionData)() {
  return &::dynamic_biped::msg::rosidl_typesupport_c::RobotHeadMotionData_message_type_support_handle;
}
