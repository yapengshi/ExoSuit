...
# each tick = 0.087890625  

# example: INVERTED_MOTORS = [3, 5, 10]
INVERTED_MOTORS = [1, 9]
...
if __name__ == "__main__":
    ...
    pub = rospy.Publisher("/kuavo_arm_traj", JointState, queue_size=10) #/kuavo_arm_traj
    rate = rospy.Rate(10)
    ...
    try:
        while not rospy.is_shutdown():
            ...
            joint_msg.position = accumulated_degrees_left + accumulated_degrees_right
