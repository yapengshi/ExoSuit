...
"""autogenerated by genpy from dynamic_biped/walkCommand.msg. Do not edit."""
import codecs
import sys
...
class walkCommand(genpy.Message):
  _md5sum = "5b32312c0e7618ca6c317ce9272f2ca7"
  _type = "dynamic_biped/walkCommand"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# mode: 0->PositionCommand | 1->VelocityCommand
uint8 mode
float64[] values
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(walkCommand, self).__init__(*args, **kwds)
